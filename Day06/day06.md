...
[<< Day 5](../Day05/day05.md) | [Day 7 >>](../Day07/day07.md)
...
1. Extract all the countries contain the word 'land' from the countries.js and print it as array
1. Find the country containing the hightest number of characters in the countries.js
1. Extract all the countries contain the word 'land' from the countries.js and print it as array
1. Extract all the countries containing only four characters from the countries.js and print it as array
1. Extract all the countries containing two or more words from the countries.js and print it as array
1. Reverse the countries.js and capitalize each country and stored it as an array
